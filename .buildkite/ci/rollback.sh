...
aws s3 sync "s3://webapps-${BUILDKITE_BRANCH}.localz.io/${S3_PATH}/${PREVIOUS_VERSION}" "s3://webapps-${BUILDKITE_BRANCH}.localz.io/${S3_PATH}/latest" --delete --acl public-read
